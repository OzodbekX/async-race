      ...
      <div className="flex shrink-0 flex-col items-center gap-1">
        <div className="flex flex-col gap-2">
          ...
          <button
            type="button"
            className={btn(
              isMoving || race.phase === 'finished' ? 'ghost' : 'success',
              true,
            )}
            onClick={() =>
              isMoving || race.phase === 'finished' ? onStop(car.id) : onStart(car.id)
            }
            disabled={raceBusy}
        ...
        <div className="relative h-10 flex-1 overflow-hidden">
          ...
          <div
            ...
            style={{
              ...
              filter:
                race.phase === 'broken' ? 'grayscale(1) brightness(0.6)' : undefined,
            }}
          >
